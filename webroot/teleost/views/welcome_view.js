...
class WelcomeView extends PagedTableView {
    constructor(tourneyName, leftPc, topPc, widthPc, heightPc, rowsPerColumn, scrollPeriod) {
        ...
        this.heading1 = null;
        this.heading2 = null;
        this.noPlayersScreen = null;
        this.playersScreen = null;
    ...
    setup(container) {
        ...
        this.noPlayersScreen = document.createElement("DIV");
        this.playersScreen = document.createElement("DIV");
        this.noPlayersScreen.className = "welcomescreenmode";
        this.playersScreen.classList.add("welcomescreenmode");

        container.appendChild(this.noPlayersScreen);
        container.appendChild(this.playersScreen);
        this.noPlayersScreen.appendChild(this.heading1);
        this.noPlayersScreen.appendChild(this.heading2);
        this.noPlayersScreen.appendChild(this.background);
        ...
        this.playersScreen.appendChild(playersHeadingBar);
        ...
        playersBlurb.className = "welcomeregistrationblurb";
        ...
        this.playersScreen.appendChild(playersBlurb);

        /* Player count */
        this.playersCount = document.createElement("DIV");
        this.playersCount.id = "welcomeregistrationcount";
        this.playersCount.innerHTML = "";
        this.playersScreen.appendChild(this.playersCount);

        /* Page number */
        this.playersPageNumber = document.createElement("DIV");
        this.playersPageNumber.id = "welcomeregistrationpagenumber";
        this.playersPageNumber.className = "viewpagenumber";
        this.playersPageNumber.innerHTML = "";
        this.playersScreen.appendChild(this.playersPageNumber);

        /* Create a container for the table of players... */
        this.playerListContainer = document.createElement("DIV");
        this.playerListContainer.className = "welcomeplayerlist";
        this.playersScreen.appendChild(this.playerListContainer);
        ...
        /* Only one of noPlayersScreen and playersScreen is visible at any
         * one time. */
        this.playersScreen.style.display = "none";
    }
    ...
    createPlayerTable(container, rows, columns) {
        ...
        table.classList.add("welcomeplayertable");
        ...
        for (let r = 0; r < rows; r++) {
            ...
            for (let c = 0; c < columns; c++) {
                ...
                td.id = "welcomeplayercell" + (c * rows + r).toString();
                ...
                if (c < columns - 1) {
                    ...
                    space.className = "welcomeplayercolumnspace";
    ...
    redrawHeadings(page) {
        ...
        if (gameState != null && gameState.success && gameState.tourney &&
            ...
            if (players.length == 0) {
                this.playersScreen.style.display = "none";
                this.noPlayersScreen.style.display = "block";
                ...
                this.playersScreen.style.display = "block";
                this.noPlayersScreen.style.display = "none";
                if (eventName && eventName != "") {
