    ...
    try:
        ...
        if "round" in form:
            try:
                ...
                response.writeln("<p>\"%s\" is not a valid round number.</p>");
        ...
        if round_no is not None:
            ...
            response.writeln("<p>");
            response.writeln("<a href=\"/cgi-bin/fixtureedit.py?tourney=%s&amp;round=%d\">Edit fixtures</a>" % (urllib.parse.quote_plus(tourney_name), round_no));
            response.writeln("<br>")
            response.writeln("<a href=\"/cgi-bin/games.py?tourney=%s&amp;round=%d\">Back to the standard Results Entry interface</a>" % (urllib.parse.quote_plus(tourney_name), round_no))
            response.writeln("</p>");
